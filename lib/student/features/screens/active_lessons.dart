...
class ActiveLessons extends StatefulWidget {
  final int lessonId;
  const ActiveLessons({
    super.key,
  ...
  @override
  State<ActiveLessons> createState() => _ActiveLessonsState();
}

class _ActiveLessonsState extends State<ActiveLessons> {
  @override
  void initState() {
    ...
    context
        ...
        .add(FetchLessonDetails(widget.lessonId.toString()));
  }
