...
//   void initState() {
//     super.initState();
//     context.read<LessonBloc>().add(FetchLessons('completed'));
...
class _CompletedPageState extends State<CompletedPage> {
  ...
  void initState() {
    super.initState();
    selectedDate = DateTime.now();
    // Initial API call for today's completed lessons
  ...
  void _fetchLessonsForDate(DateTime date) {
    ...
    context.read<LessonBloc>().add(FetchLessons('completed', date : formattedDate));
  ...
  Future<void> _pickDate(BuildContext context) async {
    ...
    final DateTime? pickedDate = await showDatePicker(
      ...
      firstDate: DateTime(1900), // Earliest selectable date (customize as needed)
      lastDate: today,   // Block future dates, allow today
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    Text(
                                      'No completed classes on this date.',
                                      style: TextStyle(
                                        fontSize: 12.sp,
