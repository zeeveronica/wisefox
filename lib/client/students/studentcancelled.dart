...
import 'package:wisefox/client/features/screens/cancelled_lessons.dart';
...
class StudentCancelledPage extends StatefulWidget {
  const StudentCancelledPage({super.key});

  @override
  State<StudentCancelledPage> createState() => _StudentCancelledPageState();
}

class _StudentCancelledPageState extends State<StudentCancelledPage> {
  ...
  void initState() {
    super.initState();
    context.read<StudentLessonBloc>().add(FetchStudentLessons('cancelled'));
