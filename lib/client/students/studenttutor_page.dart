...
class _StudentTutorPageState extends State<StudentTutorPage> {
  @override
  void initState() {
    context.read<StudentTutorBloc>().add(FetchStudentTutors());
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                BlocBuilder<StudentTutorBloc, StudentTutorState>(
                  builder: (context, state) {
                    if (state is StudentTutorLoading) {
                      return Center(
                          child: CircularProgressIndicator(
                              color: theColors.primaryColor));
                    } else if (state is StudentTutorLoaded) {
                      return Row(
                    ...
                    } else if (state is StudentTutorError) {
