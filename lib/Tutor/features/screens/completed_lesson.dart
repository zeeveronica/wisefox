...
class TutorCompletedPage extends StatefulWidget {
  const TutorCompletedPage({super.key});

  @override
  State<TutorCompletedPage> createState() => _TutorCompletedPageState();
}

class _TutorCompletedPageState extends State<TutorCompletedPage> {
  ...
  Future<void> loadSavedTimezone() async {
    ...
    if (_selectedTimeZone != 'UTC') {
      context
          .read<ClientLessonBloc>()
          .add(FetchLessons('completed', _selectedTimeZone));
    }
  }
