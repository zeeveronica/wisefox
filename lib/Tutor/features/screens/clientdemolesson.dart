...
class ClientDemoSeeall extends StatefulWidget {
  const ClientDemoSeeall({super.key});

  @override
  State<ClientDemoSeeall> createState() => _ClientDemoSeeallState();
}

class _ClientDemoSeeallState extends State<ClientDemoSeeall> {
  @override
  void initState() {
    super.initState();
    loadSavedTimezone();
                ...
                if (state is ClientDemoLessonLoaded &&
                  ...
                  return Expanded(
                    child: ListView.builder(
                      itemCount:
                          state.lessons.length, // Dynamically set the count
                      padding: EdgeInsets.only(top: w * 0.08),
                      itemBuilder: (context, index) {
                        final demoLesson = state.lessons[
                                            ...
                                            children: [
                                              Row(
                                                children: [
                                                  ...
                                                  Text(
                                                    "  Duration: ${demoLesson.lessonDuration} hr",
                                                    style: TextStyle(
                                                        fontSize: 9.sp),
                                                  ),
                                                ],
