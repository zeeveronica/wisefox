...
class TutorCancelledPage extends StatefulWidget {
  const TutorCancelledPage({super.key});

  @override
  State<TutorCancelledPage> createState() => _TutorCancelledPageState();
}

class _TutorCancelledPageState extends State<TutorCancelledPage> {
    ...
    loadSavedTimezone().then((_) {
      ...
      if (_selectedTimeZone != null && _selectedTimeZone.isNotEmpty) {
        ...
        context
            ...
            .add(FetchLessons('cancelled', _selectedTimeZone));
      } else {
