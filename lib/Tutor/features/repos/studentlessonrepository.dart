...
class StudentLessonRepository {
  ...
  StudentLessonRepository({ApiService? apiService})
  ...
  Future<List<StudentLessonModel>> fetchDemoLessons(String demotype) async {
    var loginData = await SharedPreferencesHelper.getData("loginData");
    ...
    try {
      ...
      final url = '${Urls.studentlesson}?id=$studentId&demotype=$demotype';
